...
- **Data Investigator:** open `tracks/02_data_investigator.ipynb`; change one analysis choice and compare it with the default.
- **Technical Extender:** open `tracks/03_technical_extender.ipynb`; validate methods and tests, then optionally select another challenge.
...
- What assumptions or missing data could change that interpretation?
- Who should review the finding before it is shared?
