...
| Time | Scheduled activity | Lead |
| --- | --- | --- |
| 8:30 a.m. | Breakfast and registration/check-in | Alexia Jones, MS-CC |
| 9:00 a.m. | Opening prayer and words of encouragement | James Rattling Leaf, UC Boulder ESIIL; Elisha Yellow Thunder, OLC |
| 9:15 a.m. | Participant introductions, meeting logistics and schedule | Foster Sawyer, OLC |
| 9:30 a.m. | Introduction of hackathon activities | Lilly Jones, Daear Inc. |
| 10:30 a.m. | Break | — |
| 10:45 a.m. | Hackathon activities | Lilly Jones, Daear Inc. |
| 12:00 p.m. | Lunch and invited lecture on Cubedynamics | Ty Tuff, ESIIL |
| 1:00 p.m. | Hackathon projects | Lilly Jones, Daear Inc. |
| 3:00 p.m. | Break | — |
| 3:15 p.m. | Hackathon projects | Lilly Jones, Daear Inc. |
| 5:00 p.m. | Supper and optional mentor help sessions | Mentors |
...
Allow a brief return from the Cubedynamics lecture, then project work with mentor rounds. Investigator teams examine gauge coverage and time windows; technical teams validate methods; explorer teams deepen interpretation or adapt the question. At about 2:30, check that each team can explain its source, place, period and units. Connecting the lecture to a project is optional, not a new software prerequisite.
